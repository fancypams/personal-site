...
export default {
    data() {
        return {
            jobs: [
                {title:'UI/UX Developer II', employer:"O'Reilly Auto Parts", date:'June 2020 - present', description:'Front end development for the O’Reilly online store using Vue.js, LESS, and jQuery; Active involvement in online ADA compliance task force for online store team; Application feature rewrites as well as ES6 implementations' },
                {title:'UI/UX Developer II', employer:"O'Reilly Auto Parts", date:'Dec. 2018 - June 2020', description:'Design and develop human-driven solutions for point of sale team members using Java, JavaFX, and SASS; Determine and implement style standards across all Retail projects; Develop style guide application for interactive use of style standards' },
